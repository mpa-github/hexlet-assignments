...
public class UsersController {
    ...
    public User updateUser(@Parameter(description = "User data to update") @RequestBody User updatedUser,
                           @Parameter(description = "Id of user to be updated") @PathVariable(name = "id") long id) {
        if (!userRepository.existsById(id)) {
            throw new UserNotFoundException(id);
        }
