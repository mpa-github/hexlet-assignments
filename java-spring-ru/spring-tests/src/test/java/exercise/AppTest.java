...
public class AppTest {
    ...
    public void testGetPerson() throws Exception {
        ...
        assertThat(response.getStatus()).isEqualTo(200);
        assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(response.getContentAsString()).contains("1", "John", "Smith");
    }
    ...
    public void testUpdatePerson() throws Exception {
        MockHttpServletResponse responsePost = mockMvc
            .perform(patch("/people/4")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"firstName\": \"Robert\", \"lastName\": \"Unlock\"}"))
            .andReturn()
            .getResponse();
        ...
        assertThat(responseGet.getContentAsString()).contains("4", "Robert", "Unlock");
    }
    ...
    public void testDeletePerson() throws Exception {
        ...
        assertThat(responseGetAll.getStatus()).isEqualTo(200);
        assertThat(responseGetAll.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(responseGetAll.getContentAsString()).doesNotContain("4", "Robert", "Unlock");
    }
    // END
}
