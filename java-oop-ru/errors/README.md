...
* Создайте класс `Circle`, описывающий круг. 
* Конструктор класса принимает в качестве аргумента точку `Point` и радиус в виде целого числа. В классе определите публичные методы:
...
* который принимает в качестве аргумента круг `Circle` и печатает на экран его площадь, округленную до целого числа. 
* Если в процессе вычисления площади возникло исключение, 
